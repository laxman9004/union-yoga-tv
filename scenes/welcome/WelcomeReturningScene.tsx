...
export function WelcomeReturningScene({ snapshot }: { snapshot: FrameSnapshot }) {
  ...
  return (
    <SceneShell snapshot={snapshot}>
      ...
      <h2 className="font-serif text-[clamp(56px,7vw,110px)] leading-[1.02] tracking-tight text-forest-deep">
        {c.firstName}
      ...
      <p className="mt-4 font-sans text-[clamp(18px,1.6vw,26px)] text-moss/90">
        {c.classType}
      </p>
    </SceneShell>
  );
